# water-corridor-t+soil.tile.py
#
# Water forms a T junction open to left, right, and top through soil.
...
tile = Tile(
    ...
    areas=[
        ...
        Region(id='bank', selector=FloodFill((0.18, 0.88), (0.82, 0.88), (0.5, 0.18)), layers=[SoilCarpet()]),
